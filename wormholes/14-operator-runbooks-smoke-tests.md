...
Manual verification checklists for install, portals, projection, RTP, dimensional doors, networking codes, and projection maintenance. Use an isolated test instance when possible. Commands use aliases `/wormholes`, `/wh`, or `/wormhole`. Architecture context: [Runtime Architecture](/wormholes/13-runtime-architecture). Permissions: [Commands & Permissions](/wormholes/09-commands-permissions).
...
See [Building Portals](/wormholes/03-building-portals) and [Portal Types Menus & Settings](/wormholes/04-portal-types-menus-settings).
...
| 6 | Set quality to `performance`, reload. | Entity spoofing off; range/depth/budgets clamped per [Projection Modes & Settings](/wormholes/05-projection-modes-settings). |
...
| 3 | Confirm defaults if untouched: min 512, max 4096, center portal-relative, vertical surface, allocation shared, rotation on-traversal, rim/sound on. | Status/settings match [Random Teleport Portals](/wormholes/06-random-teleport-portals). |
...
| 4 | Open physical door A (if OpenState is Open) and walk through the portal surface. | Teleport to B; orientation rules per [Dimensional Doors](/wormholes/07-dimensional-doors); open-state source may close after living traveler. |
...
| Trapdoor | Repeat Pair and one pocket path with trapdoor products. | Top/bottom aperture mapping and OpenState match [Dimensional Doors](/wormholes/07-dimensional-doors). |
...
Details: [Cross-Server Networking](/wormholes/10-cross-server-networking). Import/export services are constructed during network bootstrap even when diagnosing disabled network; status commands report disabled/not running when appropriate.
...
- Config: [Installation & Configuration](/wormholes/01-installation-configuration)
- Building: [Building Portals](/wormholes/03-building-portals)
- Menus: [Portal Types Menus & Settings](/wormholes/04-portal-types-menus-settings)
- Projection: [Projection Modes & Settings](/wormholes/05-projection-modes-settings)
- RTP: [Random Teleport Portals](/wormholes/06-random-teleport-portals)
- Doors: [Dimensional Doors](/wormholes/07-dimensional-doors)
- Commands: [Commands & Permissions](/wormholes/09-commands-permissions)
- Network: [Cross-Server Networking](/wormholes/10-cross-server-networking)
- Architecture: [Runtime Architecture](/wormholes/13-runtime-architecture)
