...
Install and `config/wormholes.toml` are covered in [01 - Installation & Configuration](/wormholes/01-installation-configuration).
...
Base command aliases (see [09 - Commands & Permissions](/wormholes/09-commands-permissions) for the full tree):
