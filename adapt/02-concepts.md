...
Mutations are a separate, opt-in track: two slots, paired domains, a combat lock, discovery, and an end-game perfect adaptation state. They are not adaptations, they do not spend knowledge, and they are disabled until an operator turns them on. See [34 - Mutations Overview](/adapt/34-mutations-overview).
