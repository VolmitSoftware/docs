...
Skill level is derived from skill XP using the global `xpCurve` (see [Configuration Math](/adapt/05-configuration-math)). Level is clamped by `experienceMaxLevel`.
