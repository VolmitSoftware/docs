...
[44 - API - Ability Cost.md](/adapt/44-api-ability-cost#observing-and-vetoing-with-events>). This document covers the rest.

**No event grants anything.** Cancelling refuses; not cancelling permits nothing that was not already
permitted. See [Skill items are inert without their adaptation](/adapt/41-api-getting-started#skill-items-are-inert-without-their-adaptation>).
...
[`AbilityUsePolicy`](/adapt/43-api-ability-use-policy) is consulted, and after the world, game-mode, protection,
...
[Adapt relocates VolmLib](/adapt/41-api-getting-started#adapt-relocates-volmlib-do-not-reference-relocated-types>).
