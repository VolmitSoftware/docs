...
If what you want is "show me this player's mutations", read them through PlaceholderAPI instead. That path is snapshot-backed, thread-safe, and documented in [47 - API - PlaceholderAPI.md](/adapt/47-api-placeholderapi).
...
|------|------------------------------|
| `MutationConfig` | Owns `plugins/Adapt/adapt/mutations.toml`, the per-mutation profile subclasses, consent mode, reload and world checks, and live static config state. Read [34 - Mutations Overview.md](/adapt/34-mutations-overview) instead of calling its lifecycle methods |
...
- [04 - Commands & Permissions.md](/adapt/04-commands-permissions)
- [34 - Mutations Overview.md](/adapt/34-mutations-overview)
- [35 - Mutations Catalog.md](/adapt/35-mutations-catalog)
- [47 - API - PlaceholderAPI.md](/adapt/47-api-placeholderapi)
