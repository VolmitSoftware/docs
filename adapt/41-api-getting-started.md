...
rather than by walking a skill's collection. [45 - API - Events.md](/adapt/45-api-events) lists the safe
...
- **The older `AdaptEvent` family** carries an async flag computed from the firing thread and can
  genuinely be asynchronous. See [45 - API - Events.md](/adapt/45-api-events#threading).
...
any thread. See [47 - API - PlaceholderAPI.md](/adapt/47-api-placeholderapi).
...
| gate block and entity actions on claims or regions | `Protector` (`ProtectorRegistry`) | [46 - API - Protection.md](/adapt/46-api-protection) |
...
| watch or veto activation and adaptation events | the ability events and the `AdaptEvent` family | [45 - API - Events.md](/adapt/45-api-events) |
...
| inspect mutation catalogue and snapshot value objects | `MutationCatalog`, `MutationSnapshot` | [48 - API - Mutations.md](/adapt/48-api-mutations) |
...
| build recipes and effects, or read diagnostics | recipe, FX, telemetry, projectile, and value helpers | [50 - API - Recipes, FX, Telemetry & Utilities.md](/adapt/50-api-recipes-fx-telemetry-utilities) |
...
|---|---|---|
| `[abilityApi]` | the whole ability API: master switch, failure modes, fault limit, slow-call threshold, denial throttle | [43 - API - Ability Use Policy.md](/adapt/43-api-ability-use-policy#configuration), [44 - API - Ability Cost.md](/adapt/44-api-ability-cost#configuration) |
