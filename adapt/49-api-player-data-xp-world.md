...
After Adapt has enabled, obtain the server through `Adapt.instance.getAdaptServer()` or a checked plugin lookup as shown in [API - Skills & Adaptations](/adapt/42-api-skills-adaptations).
