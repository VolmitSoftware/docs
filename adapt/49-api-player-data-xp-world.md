...
Get the server through `Adapt.instance.getAdaptServer()`, or through the checked plugin lookup shown in [42 - API - Skills & Adaptations.md](/adapt/42-api-skills-adaptations), once Adapt has enabled.
...
- [02 - Concepts.md](/adapt/02-concepts)
- [05 - Configuration Math.md](/adapt/05-configuration-math)
- [38 - Runtime Architecture.md](/adapt/38-runtime-architecture)
- [42 - API - Skills & Adaptations.md](/adapt/42-api-skills-adaptations)
- [48 - API - Mutations.md](/adapt/48-api-mutations)
