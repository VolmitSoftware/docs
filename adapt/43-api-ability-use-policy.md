...
| 4 | `Protector.checkRegion(...)` for land claims and regions | [46 - API - Protection.md](/adapt/46-api-protection) |
| 5 | `adapt.use.<adaptation>` permission; unset or op means granted | [41 - API - Getting Started.md](/adapt/41-api-getting-started) |
| 6 | no usage conflict with another adaptation | |
| 7 | `AdaptAdaptationUseEvent` not cancelled | [45 - API - Events.md](/adapt/45-api-events) |
...
| `costProviderFailureMode` | `"allow"` | The cost funnel's equivalent. See [44 - API - Ability Cost.md](/adapt/44-api-ability-cost#configuration) |
