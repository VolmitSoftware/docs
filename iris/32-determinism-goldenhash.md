...
---
GoldenHash compares terrain generated from the same pack, seed, center, radius, and height range. Use it when checking whether an update changed generation.
