...
description: "Iris biome atlas entry for vanilla/windswept_forest in Overworld and Underworld"
published: true
...
---
`vanilla/windswept_forest` is a directly selected land biome in the Overworld and Underworld packs. Overworld and Underworld use the same terrain with different materials, Minecraft biome identities, decorations, and ecology.
...
|---|---|---:|---|---|---|---|
| `vanilla/windswept_forest` | Cliff | 56 | 224 / 30 | 14 / 2.25 / 336 | 0.12 / 0.4 | `IRIS_HALF` / `SIMPLEX` |
...
- **Minecraft identity:** derivative `minecraft:windswept_forest`; native-structure derivative `minecraft:windswept_forest`; custom identities `windswept_forest`.
...
- **Minecraft identity:** derivative `minecraft:basalt_deltas`; native-structure derivative `minecraft:basalt_deltas`; custom identities `underworld_vanilla_windswept_forest_fbe6489b`.
...
```text
/iris find biome vanilla/windswept_forest
/iris what biome
/iris what region
```
