...
`carving/chalk-gardens` is a direct cave root in the current Overworld and Underworld pack sources. The packs preserve its spatial identity while changing materials, registered biome effects and ecology for their respective dimensions.
...
|------|-------------------------|-----------------------|-----------------------|
| Overworld source | `estranged` (1/6 slots; region rarity 1, weight `1/1`); `temperate` (1/6 slots; region rarity 1, weight `1/1`); `terralost` (1/5 slots; region rarity 5, weight `1/5`) | `1` | `1/1` |
| Underworld source | `estranged` (1/6 slots; region rarity 1, weight `1/1`); `temperate` (1/6 slots; region rarity 1, weight `1/1`); `terralost` (1/5 slots; region rarity 5, weight `1/5`) | `1` | `1/1` |
