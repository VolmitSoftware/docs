...
**Overworld carving.** Enabled local cave profile with declared vertical range `6..680`; sample step `2`; surface clearance `12`; surface breaking `disabled`; aquifers `disabled`; lava `allowed`; a minimum depth below surface of `12`.
