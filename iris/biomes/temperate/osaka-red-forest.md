...
description: "Iris biome atlas entry for temperate/osaka-red-forest in Overworld and Underworld"
published: true
...
---
`temperate/osaka-red-forest` is a directly selected land biome in the Overworld and Underworld packs. Overworld and Underworld use the same terrain with different materials, Minecraft biome identities, decorations, and ecology.
...
|---|---|---:|---:|---:|---:|
| Overworld | `forests` (Forests) | 1 | 4 | 0.25 | 2.86% |
| Overworld | `temperate` (Temperate) | 1 | 4 | 0.25 | 1.54% |
| Underworld | `forests` (Forests) | 1 | 4 | 0.25 | 2.86% |
