...
description: "Iris biome atlas entry for temperate/osaka-red-forest in Overworld 4007 and Underworld 1010"
published: true
...
---
`temperate/osaka-red-forest` is a directly selected land biome in the current Overworld 4007 and Underworld 1010 packs. Overworld and Underworld use the same terrain with different materials, Minecraft biome identities, decorations, and ecology.
...
|---|---|---:|---:|---:|---:|
| Overworld 4007 | `forests` (Forests) | 1 | 4 | 0.25 | 2.86% |
| Overworld 4007 | `temperate` (Temperate) | 1 | 4 | 0.25 | 1.54% |
| Underworld 1010 | `forests` (Underworld Forests) | 1 | 4 | 0.25 | 2.86% |
...
|---|---|---:|---|---|---|---|
| `temperate/osaka-red-forest` | Lowland | 10 | 192 / 24 | None | 0.18 / 0.48 | `PERLIN` / None |
