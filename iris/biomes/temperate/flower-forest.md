...
description: "Iris biome atlas entry for temperate/flower-forest in Overworld and Underworld"
published: true
...
---
`temperate/flower-forest` is a directly selected land biome in the Overworld and Underworld packs. Overworld and Underworld use the same terrain with different materials, Minecraft biome identities, decorations, and ecology.
...
|---|---|---:|---:|---:|---:|
| Overworld | `forests` (Forests) | 1 | 3 | 0.3333 | 3.82% |
| Underworld | `forests` (Forests) | 1 | 3 | 0.3333 | 3.82% |
