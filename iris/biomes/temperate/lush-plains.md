...
|---|---|---:|---|---|---|---|
| `temperate/lush-plains` | Lowland | 10 | 192 / 24 | None | 0.18 / 0.48 | `PERLIN` / None |
| `temperate/lush-plains-red` | Lowland | 10 | 192 / 24 | None | 0.18 / 0.48 | `PERLIN` / None |
| `temperate/lush-plains-yellow` | Lowland | 10 | 192 / 24 | None | 0.18 / 0.48 | `PERLIN` / None |
| `temperate/overflowed` | Protected | 0 | None | None | None | None / None |
