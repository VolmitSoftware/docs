...
description: "Iris biome atlas entry for temperate/stranged-plains in Overworld and Underworld"
published: true
...
---
`temperate/stranged-plains` is a directly selected land biome in the Overworld and Underworld packs. Overworld and Underworld use the same terrain with different materials, Minecraft biome identities, decorations, and ecology.
...
|---|---|---:|---:|---:|---:|
| Overworld | `temperate` (Temperate) | 1 | 5 | 0.2 | 1.23% |
| Underworld | `temperate` (Temperate) | 1 | 5 | 0.2 | 1.23% |
...
|---|---|---:|---|---|---|---|
| `temperate/stranged-plains` | Lowland | 10 | 192 / 24 | None | 0.18 / 0.48 | `PERLIN` / None |
