---
title: "Biome Atlas — Prismatics Purple"
description: "Iris biome atlas entry for prismatics/purple in Overworld and Underworld"
published: true
...
---
`prismatics/purple` is a directly selected land biome in the Overworld and Underworld packs. Overworld and Underworld use the same terrain with different materials, Minecraft biome identities, decorations, and ecology.
...
|---|---|---:|---|---|---|---|
| `prismatics/purple` | Prismatic | 36 | 256 / 24 | 8 / 2 / 392 | 0.14 / 0.42 | `HEXAGON` / `SIMPLEX` |
...
- **Surface:** 2-3 block(s): `minecraft:purple_concrete_powder`; 4-8 block(s): `minecraft:purple_concrete`. Wall palette: `minecraft:purple_concrete`.
...
- **Minecraft identity:** derivative `minecraft:basalt_deltas`; native-structure derivative `minecraft:basalt_deltas`; custom identities `underworld_prismatics_purple_8469ffce`.
- **Surface:** 2-3 block(s): `minecraft:crying_obsidian`; 4-8 block(s): `minecraft:crying_obsidian`. Wall palette: `minecraft:crying_obsidian`.
...
```text
/iris find biome prismatics/purple
/iris what biome
/iris what region
```
