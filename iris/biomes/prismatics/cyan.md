---
title: "Biome Atlas — Prismatics Cyan"
description: "Iris biome atlas entry for prismatics/cyan in Overworld and Underworld"
published: true
...
---
`prismatics/cyan` is a directly selected land biome in the Overworld and Underworld packs. Overworld and Underworld use the same terrain with different materials, Minecraft biome identities, decorations, and ecology.
...
|---|---|---:|---|---|---|---|
| `prismatics/cyan` | Prismatic | 36 | 256 / 24 | 8 / 2 / 392 | 0.14 / 0.42 | `HEXAGON` / `SIMPLEX` |
...
- **Surface:** 2-3 block(s): `minecraft:cyan_concrete_powder`; 4-8 block(s): `minecraft:cyan_concrete`. Wall palette: `minecraft:cyan_concrete`.
...
- **Minecraft identity:** derivative `minecraft:basalt_deltas`; native-structure derivative `minecraft:basalt_deltas`; custom identities `underworld_prismatics_cyan_5dc9b2ab`.
...
```text
/iris find biome prismatics/cyan
/iris what biome
/iris what region
```
