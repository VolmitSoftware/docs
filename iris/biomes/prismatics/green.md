---
title: "Biome Atlas — Prismatics Green"
description: "Iris biome atlas entry for prismatics/green in Overworld and Underworld"
published: true
...
---
`prismatics/green` is a directly selected land biome in the Overworld and Underworld packs. Overworld and Underworld use the same terrain with different materials, Minecraft biome identities, decorations, and ecology.
...
|---|---|---:|---|---|---|---|
| `prismatics/green` | Prismatic | 36 | 256 / 24 | 8 / 2 / 392 | 0.14 / 0.42 | `HEXAGON` / `SIMPLEX` |
...
- **Surface:** 2-3 block(s): `minecraft:green_concrete_powder`; 4-8 block(s): `minecraft:green_concrete`. Wall palette: `minecraft:green_concrete`.
...
- **Minecraft identity:** derivative `minecraft:basalt_deltas`; native-structure derivative `minecraft:basalt_deltas`; custom identities `underworld_prismatics_green_70cd70fa`.
- **Surface:** 2-3 block(s): `minecraft:warped_nylium`; 4-8 block(s): `minecraft:warped_nylium`. Wall palette: `minecraft:warped_nylium`.
...
```text
/iris find biome prismatics/green
/iris what biome
/iris what region
```
