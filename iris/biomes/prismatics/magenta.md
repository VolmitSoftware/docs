---
title: "Biome Atlas — Prismatics Magenta"
description: "Iris biome atlas entry for prismatics/magenta in Overworld and Underworld"
published: true
...
---
`prismatics/magenta` is a directly selected land biome in the Overworld and Underworld packs. Overworld and Underworld use the same terrain with different materials, Minecraft biome identities, decorations, and ecology.
...
|---|---|---:|---|---|---|---|
| `prismatics/magenta` | Prismatic | 36 | 256 / 24 | 8 / 2 / 392 | 0.14 / 0.42 | `HEXAGON` / `SIMPLEX` |
...
- **Surface:** 2-3 block(s): `minecraft:magenta_concrete_powder`; 4-8 block(s): `minecraft:magenta_concrete`. Wall palette: `minecraft:magenta_concrete`.
...
- **Minecraft identity:** derivative `minecraft:basalt_deltas`; native-structure derivative `minecraft:basalt_deltas`; custom identities `underworld_prismatics_magenta_009af8c0`.
- **Surface:** 2-3 block(s): `minecraft:nether_wart_block`; 4-8 block(s): `minecraft:nether_wart_block`. Wall palette: `minecraft:nether_wart_block`.
...
```text
/iris find biome prismatics/magenta
/iris what biome
/iris what region
```
