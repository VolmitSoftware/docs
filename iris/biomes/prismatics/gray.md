---
title: "Biome Atlas — Prismatics Gray"
description: "Iris biome atlas entry for prismatics/gray in Overworld and Underworld"
published: true
...
---
`prismatics/gray` is a directly selected land biome in the Overworld and Underworld packs. Overworld and Underworld use the same terrain with different materials, Minecraft biome identities, decorations, and ecology.
...
|---|---|---:|---|---|---|---|
| `prismatics/gray` | Prismatic | 36 | 256 / 24 | 8 / 2 / 392 | 0.14 / 0.42 | `HEXAGON` / `SIMPLEX` |
...
- **Surface:** 2-3 block(s): `minecraft:gray_concrete_powder`; 4-8 block(s): `minecraft:gray_concrete`. Wall palette: `minecraft:gray_concrete`.
...
- **Minecraft identity:** derivative `minecraft:basalt_deltas`; native-structure derivative `minecraft:basalt_deltas`; custom identities `underworld_prismatics_gray_36d2539c`.
- **Surface:** 2-3 block(s): `minecraft:polished_blackstone`; 4-8 block(s): `minecraft:polished_blackstone`. Wall palette: `minecraft:polished_blackstone`.
...
```text
/iris find biome prismatics/gray
/iris what biome
/iris what region
```
