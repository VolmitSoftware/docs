---
title: "Biome Atlas — Prismatics Black"
description: "Iris biome atlas entry for prismatics/black in Overworld and Underworld"
published: true
...
---
`prismatics/black` is a directly selected land biome in the Overworld and Underworld packs. Overworld and Underworld use the same terrain with different materials, Minecraft biome identities, decorations, and ecology.
...
|---|---|---:|---|---|---|---|
| `prismatics/black` | Prismatic | 36 | 256 / 24 | 8 / 2 / 392 | 0.14 / 0.42 | `HEXAGON` / `SIMPLEX` |
...
- **Surface:** 2-3 block(s): `minecraft:black_concrete_powder`; 4-8 block(s): `minecraft:black_concrete`. Wall palette: `minecraft:black_concrete`.
...
- **Minecraft identity:** derivative `minecraft:basalt_deltas`; native-structure derivative `minecraft:basalt_deltas`; custom identities `underworld_prismatics_black_a66fa9fb`.
- **Surface:** 2-3 block(s): `minecraft:blackstone`; 4-8 block(s): `minecraft:blackstone`. Wall palette: `minecraft:blackstone`.
...
```text
/iris find biome prismatics/black
/iris what biome
/iris what region
```
