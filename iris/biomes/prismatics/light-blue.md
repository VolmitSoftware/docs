---
title: "Biome Atlas — Prismatics Light Blue"
description: "Iris biome atlas entry for prismatics/light-blue in Overworld and Underworld"
published: true
...
---
`prismatics/light-blue` is a directly selected land biome in the Overworld and Underworld packs. Overworld and Underworld use the same terrain with different materials, Minecraft biome identities, decorations, and ecology.
...
|---|---|---:|---|---|---|---|
| `prismatics/light-blue` | Prismatic | 36 | 256 / 24 | 8 / 2 / 392 | 0.14 / 0.42 | `HEXAGON` / `SIMPLEX` |
...
- **Surface:** 2-3 block(s): `minecraft:light_blue_concrete_powder`; 4-8 block(s): `minecraft:light_blue_concrete`. Wall palette: `minecraft:light_blue_concrete`.
...
- **Minecraft identity:** derivative `minecraft:basalt_deltas`; native-structure derivative `minecraft:basalt_deltas`; custom identities `underworld_prismatics_light_blue_d88fc221`.
...
```text
/iris find biome prismatics/light-blue
/iris what biome
/iris what region
```
