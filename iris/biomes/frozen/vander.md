...
description: "Iris biome atlas entry for frozen/vander in Overworld 4009 and Underworld 1011"
published: true
...
---
`frozen/vander` is a directly selected land biome in the current Overworld 4009 and Underworld 1011 packs. Overworld and Underworld use the same terrain with different materials, Minecraft biome identities, decorations, and ecology.
...
|---|---|---:|---:|---:|---:|
| Overworld 4009 | `frozen` (Frozen) | 1 | 4 | 0.25 | 1.42% |
| Underworld 1011 | `frozen` (Frozen) | 1 | 4 | 0.25 | 1.42% |
...
|---|---|---:|---|---|---|---|
| `frozen/vander` | Hills | 22 | 256 / 30 | None | 0.18 / 0.5 | `SIMPLEX` / None |
