...
description: "Iris biome atlas entry for tundra/mountains in Overworld and Underworld"
published: true
...
---
`tundra/mountains` is a directly selected land biome in the Overworld and Underworld packs. Overworld and Underworld use the same terrain with different materials, Minecraft biome identities, decorations, and ecology.
...
|---|---|---:|---:|---:|---:|
| Overworld | `tundra` (Tundra) | 2 | 1 | 2 | 12.25% |
| Underworld | `tundra` (Tundra) | 2 | 1 | 2 | 12.25% |
...
|---|---|---:|---|---|---|---|
| `tundra/mountains` | Forest | 30 | 280 / 36 | None | 0.2 / 0.55 | `PERLIN` / None |
