...
description: "Iris biome atlas entry for tropical/rainforest-hills in Overworld and Underworld"
published: true
...
---
`tropical/rainforest-hills` is a directly selected land biome in the Overworld and Underworld packs. Overworld and Underworld use the same terrain with different materials, Minecraft biome identities, decorations, and ecology.
...
|---|---|---:|---|---|---|---|
| `tropical/rainforest-hills` | Cliff | 56 | 224 / 30 | 14 / 2.25 / 336 | 0.12 / 0.4 | `NOWHERE` / `SIMPLEX` |
