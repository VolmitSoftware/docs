...
|---|---|---:|---|---|---|---|
| `tropical/rainforest-wicked` | Forest | 30 | 280 / 36 | None | 0.2 / 0.55 | `NOWHERE` / None |
| `tropical/jungle-denmyre` | Lowland | 10 | 192 / 24 | None | 0.18 / 0.48 | `PERLIN` / None |
| `tropical/rainforest-wicked-child` | Cliff | 56 | 224 / 30 | 14 / 2.25 / 336 | 0.12 / 0.4 | `NOWHERE` / `SIMPLEX` |
