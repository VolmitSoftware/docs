...
description: "Iris biome atlas entry for tropical/rainforest-wicked in Overworld 4002 and Underworld 1005"
published: true
...
---
`tropical/rainforest-wicked` is a directly selected land biome in the pinned Overworld 4002 and Underworld 1005 packs. The two packs preserve its terrain identity while applying different materials, Minecraft biome identities, decoration and ecology.
...
Children that are also direct land roots have their own atlas pages: [`tropical/rainforest-hills`](/iris/biomes/tropical/rainforest-hills).

### Tropical Jungle Denmyre (`tropical/jungle-denmyre`)

This child-only biome is selected from `tropical/rainforest-wicked`, not from a region list. Its rarity is `1`.
...
```text
/iris find biome tropical/rainforest-wicked
/iris what biome
/iris what region
```
