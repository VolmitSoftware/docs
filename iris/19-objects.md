...
The object is finished when `analyze` reports the dimensions you expect, a fresh paste lines up on the target block, and a save/reopen cycle changes nothing. Then continue with [20 - Object Placement](/iris/20-object-placement).
