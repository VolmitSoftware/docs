...
Pregeneration automatically prepares hydrology as needed and reuses matching saved plans. It uses the world's configured rivers, caves, biomes, and terrain detail. The radius sets the requested area, not a world border; neighboring chunks needed to complete that area can also generate.
