...
| `util.plugin` | `SplashScreenSupport` (shared console-splash metadata: Java major version, server version, startup date, release train), `LegacyConsoleLog` (Paper component-logger rendering with a clean Java-logger fallback), `CancellableTask` |
